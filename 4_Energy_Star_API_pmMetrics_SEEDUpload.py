...
del metrictopull[0]
metricNames = [pmMetricsToPull.cell_value(r, 1) for r in range(pmMetricsToPull.nrows)]
metricNames = [str(item) for item in metricNames]
...
del metricNames[0]
metricNames.insert(0, "Metered Areas (Energy)")
metricNames.insert(0, "Metered Areas (Water)")
metricNames.insert(0, "LEED US Project ID")
metricNames.insert(0, "Custom Property ID 1 - ID")
metricNames.insert(0, "District of Columbia Building Unique ID")
metricNames.insert(0, "District of Columbia Real Property Unique ID")
metricNames.insert(0, "Web Services Pull Date")
metricNames.insert(0, "propertyContactName_Custom")
metricNames.insert(0, "propertyContactEmail_Custom")
metricNames.insert(0, "Property Notes")
metricNames.insert(0, "Irrigated Area")
metricNames.insert(0, "Occupancy")
metricNames.insert(0, "Year Built")
metricNames.insert(0, "Number of Buildings")
metricNames.insert(0, "Construction Status")
metricNames.insert(0, "Primary Property Type - Self Selected")
metricNames.insert(0, "Postal Code")
metricNames.insert(0, "State/Province")
metricNames.insert(0, "City")
metricNames.insert(0, "Address 2")
metricNames.insert(0, "Address 1")
metricNames.insert(0, "Property Name")
metricNames.insert(0, "DCRealPropertyID_CustomAdditional")
metricNames.insert(0, "DCRealPropertyID_Custom")
metricNames.insert(0, "PropertyID")




metricNames.extend(['Elec – Dec', 'Elec – Nov', 'Elec – Oct', 'Elec – Sept', 'Elec – Aug', 'Elec – July', 'Elec – June', 'Elec – May', 'Elec – Apr', 'Elec – March', 'Elec – Feb', 'Elec – Jan'])
metricNames.extend(['NG – Dec', 'NG – Nov', 'NG – Oct', 'NG – Sept', 'NG – Aug', 'NG – July', 'NG – June', 'NG – May', 'NG – Apr', 'NG – March', 'NG – Feb', 'NG – Jan'])

with open(output_csvfile,'w',newline='') as output:
	i = len(metricNames)
	writer = csv.writer(output,  delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
	writer.writerow(metricNames[0:i])
...
with open(output_csvfile, 'r') as f:
...
payload3 = {'username': PMUserName, 'password': PMPassword,'template': SEED_pm_list_values_template}
