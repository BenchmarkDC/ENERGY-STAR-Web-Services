...
benchmarking_disclosure['percent_electric_consumption'] = benchmarking_disclosure.apply(lambda row: ((row['electricity_grid_use'] + row['electricity_renewable_use'])*3.412 )/ (row['reported_gross_floor_area']* row['site_eui'])  if row['report_status'] == 'In Compliance' and (row['reported_gross_floor_area']* row['site_eui']) != 0 else 0, axis = 1).fillna(0)
benchmarking_disclosure['percent_gas_consumption'] = benchmarking_disclosure.apply(lambda row: (row['natural_gas_use'] *100)/ (row['reported_gross_floor_area']* row['site_eui'])  if row['report_status'] == 'In Compliance' and (row['reported_gross_floor_area']* row['site_eui'])  != 0 else 0, axis = 1).fillna(0)
benchmarking_disclosure['percent_electric_emissions'] = benchmarking_disclosure.apply(lambda row: (row['percent_electric_consumption'] * row['total_ghg_emissions'])/ row['total_ghg_emissions']  if row['report_status'] == 'In Compliance' and row['total_ghg_emissions']  != 0 else 0, axis = 1).fillna(0)
benchmarking_disclosure['percent_gas_emissions'] = benchmarking_disclosure.apply(lambda row: (row['percent_gas_consumption'] * row['total_ghg_emissions'])/ row['total_ghg_emissions']  if row['report_status'] == 'In Compliance' and row['total_ghg_emissions']  != 0 else 0, axis = 1).fillna(0)
...
benchmarking_disclosure['site_eui_change_current_last'] = benchmarking_disclosure.apply(lambda row: (row['weather_norm_site_eui_'+str(row['year_ending']).replace('.0','')] - row['weather_norm_site_eui_'+str(row['year_ending']-1).replace('.0','')])/row['weather_norm_site_eui_'+str(row['year_ending']).replace('.0','')] if row['year_ending'] > 2012 and row['weather_norm_site_eui_'+str(row['year_ending']).replace('.0','')] != 0 else 0, axis = 1)
benchmarking_disclosure['source_eui_change_current_last'] = benchmarking_disclosure.apply(lambda row: (row['weather_norm_source_eui_'+str(row['year_ending']).replace('.0','')] - row['weather_norm_source_eui_'+str(row['year_ending']-1).replace('.0','')])/row['weather_norm_source_eui_'+str(row['year_ending']).replace('.0','')] if row['year_ending'] > 2012 and row['weather_norm_source_eui_'+str(row['year_ending']).replace('.0','')] != 0 else 0, axis = 1)
benchmarking_disclosure['tot_ghg_emissions_intensity_change_current_last'] = benchmarking_disclosure.apply(lambda row: (row['total_ghg_emissions_intensity_'+str(row['year_ending']).replace('.0','')] - row['total_ghg_emissions_intensity_'+str(row['year_ending']-1).replace('.0','')])/row['total_ghg_emissions_intensity_'+str(row['year_ending']).replace('.0','')] if row['year_ending'] > 2012 and row['total_ghg_emissions_intensity_'+str(row['year_ending']).replace('.0','')] != 0 else 0, axis = 1)
...
dataset = dataset_manager.create('Output\\tbl_Consolidated_2012_infinite.xlsx')
